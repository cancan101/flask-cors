...
class ExceptionInterceptionDefaultTestCase(FlaskCorsTestCase):
    ...
    def add_routes(self):
        @self.app.route('/test_no_acl_abort_404')
        @self.app.route('/test_acl_abort_404')
        def test_acl_abort_404():
            abort(404)

        @self.app.route('/test_no_acl_abort_500')
        @self.app.route('/test_acl_abort_500')
        def test_acl_abort_500():
            abort(500)

        @self.app.route('/test_acl_uncaught_exception_500')
        def test_acl_uncaught_exception_500():
            raise Exception("This could've been any exception")

        @self.app.route('/test_no_acl_uncaught_exception_500')
...
class NoExceptionInterceptionTestCase(ExceptionInterceptionDefaultTestCase):
    def __init__(self, *args, **kwargs):
        super(NoExceptionInterceptionTestCase, self).__init__(*args, **kwargs)
